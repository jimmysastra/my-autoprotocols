...
then spread 
"""
num_dilutions = 5 #dilute 1:100 each time
...
p.provision("rs17bafcbmyrmh", serial_dilution.wells_from(0, num_dilutions), "148.5:microliter")
...
for w in range(num_dilutions-1): #1E-4, 1E-6, 1E-8, 1E-10 dilutions
...
for w in range(num_dilutions-1):
