...
pglo_bact = p.ref("pglo_bact", id="ct1an73srwynym", cont_type="96-flat", storage="cold_4")
serial_dilution = p.ref("serial_dilution", cont_type="96-pcr", storage="ambient")
p.provision("rs17bafcbmyrmh", serial_dilution.wells_from(0, num_dilutions+1), "148.5:microliter")
agar = p.ref("agar_with_amp", cont_type="6-flat", storage="cold_4")
...
for w in range(num_dilutions): #1E-2, 1E-4, 1E-6, 1E-8 dilutions
...
for w in range(0,num_dilutions):
